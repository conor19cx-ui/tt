-- 设置SQL mode以允许datetime默认值
SET sql_mode = '';

-- 创建数据库
CREATE DATABASE IF NOT EXISTS icampus DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- 插入二手商品数据
INSERT INTO products (title, description, price, category, `condition`, contact, user_id, status) VALUES
